...
class WiCANAmbientMoodLightSelectEntity(CANDoEntity, SelectEntity, RestoreEntity):
...
class WiCANDriverSeatHeaterSelectEntity(CANDoEntity, SelectEntity, RestoreEntity):
