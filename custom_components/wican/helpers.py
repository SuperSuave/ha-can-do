...
_CANDoEntityT = TypeVar("_CANDoEntityT", bound="CANDoEntity")
_P = TypeVar("_P")
...
def wican_exception_handler[CANDoEntityT: "CANDoEntity"](
    func: Callable[Concatenate[_CANDoEntityT, ...], Coroutine[Any, Any, Any]],
) -> Callable[Concatenate[_CANDoEntityT, ...], Coroutine[Any, Any, None]]:
    ...
    @wraps(func)
    async def handler(self: _CANDoEntityT, *args: Any, **kwargs: Any) -> None:
