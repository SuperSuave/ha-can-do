...
class WiCANSensorEntity(CANDoEntity, RestoreSensor):
    """A sensor entity."""
...
class WiCANPidSensorEntity(CANDoEntity, RestoreSensor):
...
class WiCANCanStatesSensorEntity(CANDoEntity, RestoreSensor):
    @callback
...
class WiCANCanCatalogSensorEntity(CANDoEntity, RestoreSensor):
    @callback
    def _async_handle_event(self, webhook_id: str, data: dict[str, str]) -> None:
        pass
